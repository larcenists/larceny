...
(define print-ilist
  ...
  (let ()
    ...
    (define itable
	  ...
	  (defi $i.b.a 'b.a	 `(,imm))
	  (defi $i.bne 'bne	 `(,imm))
	  (defi $i.bne.a 'bne.a   `(,imm))
	  (defi $i.be 'be      `(,imm))
	  (defi $i.be.a 'be.a    `(,imm))
	  (defi $i.bg 'bg      `(,imm))
	  (defi $i.bg.a 'bg.a    `(,imm))
	  (defi $i.ble 'ble     `(,imm))
	  (defi $i.ble.a 'ble.a   `(,imm))
	  (defi $i.bge 'bge     `(,imm))
	  (defi $i.bge.a 'bge.a   `(,imm))
	  (defi $i.bl 'bl      `(,imm))
	  (defi $i.bl.a 'bl.a    `(,imm))
	  (defi $i.bgu 'bgu     `(,imm))
	  (defi $i.bgu.a 'bgu.a   `(,imm))
	  (defi $i.bleu 'bleu    `(,imm))
	  (defi $i.bleu.a 'bleu.a  `(,imm))
	  (defi $i.bcc 'bcc     `(,imm))
	  (defi $i.bcc.a 'bcc.a   `(,imm))
	  (defi $i.bcs 'bcs     `(,imm))
	  (defi $i.bcs.a 'bcs.a   `(,imm))
	  (defi $i.bpos 'bpos    `(,imm))
	  (defi $i.bpos.a 'bpos.a  `(,imm))
	  (defi $i.bneg 'bneg    `(,imm))
	  (defi $i.bneg.a 'bneg.a  `(,imm))
	  (defi $i.bvc 'bvc     `(,imm))
	  (defi $i.bvc.a 'bvc.a   `(,imm))
	  (defi $i.bvs 'bvs     `(,imm))
	  (defi $i.bvs.a 'bvs.a   `(,imm))
	  (defi $i.call 'call    `(,imm))
