...
;
; Based on old Sparc machine assembler.
;
; Lars Thomas Hansen
; April 28, 1996 
;
; The assembly instruction generators are themselves in the files
; Sparcasm/gen-msi.sch and Sparcasm/gen-prim.sch.
...
;
; FIXME: Does push-instruction work with the peephole optimizer in place??
