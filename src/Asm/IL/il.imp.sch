...
;                                                          effect
 (append
  `((eof-object       0 eof-object       #f             5 ,ak:dead     ,ak:none #f)
    ...
    (ustring-length   1 ustring-length   #f          8040 ,ak:immortal ,ak:none #f)
...
;    (*                2 *                #f            63 ,ak:immortal ,ak:none #t)
    ...
    (ustring-ref      2 ustring-ref      ,stdc-imm?  8078 ,ak:string   ,ak:none #f)
    (ustring-set!     3 ustring-set!     ,stdc-imm?  8079 ,ak:dead     ,ak:string #f)
