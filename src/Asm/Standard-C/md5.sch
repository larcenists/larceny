...
(let ()
  (let-syntax ((mod32
    ...
    (define (word-or w1 w2)
	  ...
	  (fxlogior w1 w2)
	  (+ (* 65536 (fxlogior (quotient w1 65536) (quotient w2 65536)))
	     (fxlogior (remainder w1 65536) (remainder w2 65536)))))

    (define (word-not w)
      (if (fixnum? w)
	  (+ (* 65536 (fxlogand (fxlognot (fxrsha w 16)) 65535))
	     (fxlogand (fxlognot (fxlogand w 65535)) 65535))
	  (- 4294967295 w)))

    (define (word-xor w1 w2)
      (if (and (fixnum? w1) (fixnum? w2))
	  (fxlogxor w1 w2)
	  (+ (* 65536 (fxlogxor (quotient w1 65536) (quotient w2 65536)))
	     (fxlogxor (remainder w1 65536) (remainder w2 65536)))))

    (define (word-and w1 w2)
      (if (and (fixnum? w1) (fixnum? w2))
	  (fxlogand w1 w2)
	  (+ (* 65536 (fxlogand (quotient w1 65536) (quotient w2 65536)))
	     (fxlogand (remainder w1 65536) (remainder w2 65536)))))
