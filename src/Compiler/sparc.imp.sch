...
;                                                          effect
  `((,name:CAR        1 car              #f          #x1b ,:car      ,:none)
    ...
    (.string-length:str 1 ustring-length:str #f          -1 ,:immortal ,:none)
...
;   (rational?        1 rational?        #f          #x21 ,:immortal ,:none)
    ...
    (string?          1 ustring?          #f          #x50 ,:immortal ,:none)
    (string-length    1 ustring-length:str #f        #x51 ,:immortal ,:none)
    ...
    (make-string      2 make-ustring      #f            -1 ,:dead     ,:none)
   ; FIXME: should recognize immediate operands
   ;(string-ref       2 ustring-ref:trusted ,sparc-imm? #xd1 ,:string   ,:none)
    (string-ref       2 ustring-ref:trusted #f       #xd1 ,:string   ,:none)
    (string-set!      3 ustring-set!:trusted #f        -1 ,:dead     ,:string)
...
;   (call-with-values -1 call-with-values #f           -1 ,:dead     ,:all)
    ...
    (.internal:machine-address 1 machine-address #f    -1 ,:dead     ,:none)
