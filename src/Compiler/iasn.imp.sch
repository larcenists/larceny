...
;                                                          effect
 (append
  `((eof-object       0 eof-object       #f             5 ,:dead     ,:none #f)
    ...
    (string-length    1 ustring-length   #f            40 ,:immortal ,:none #f)
...
;    (*                2 *                ,stdc-imm?    63 ,:immortal ,:none #t)
    ...
    (string-ref       2 ustring-ref      ,stdc-imm?    78 ,:string   ,:none #f)
    (string-set!      3 ustring-set!     ,stdc-imm?    79 ,:dead     ,:string #f)
