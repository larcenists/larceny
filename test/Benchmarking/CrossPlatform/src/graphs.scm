...
; Modified 16 November 1998 by Will Clinger to replaced graphs-benchmark
; by main.
; Modified 21 August 2006 by Will Clinger to remove un-executed
; calls to the assert procedure that caused a certain compiler
; to break.
;
