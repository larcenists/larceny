...
; (One of the benchmarked systems has a problem with calls to them.)
;
; Also had to add this:

(define (pretty-print . args) #t)
...
; 981116 / wdc Removed all i/o and replaced dynamic-benchmark with main.
...
(define (main . args)
  (run-benchmark
    ...
    doit
    (lambda (result)
      (equal? result '((218 . 442) (6 . 1904) (2209 . 452))))))
