...
;                                                          effect
  ...
  (append
  `(
    (break            0 break            #f             1 ,ak:dead     ,ak:all  #f)
    ...
    (lognot           1 lognot           #f            33 ,ak:immortal ,ak:none #f)
    ...
    (logand           2 logand           #f            71 ,ak:immortal ,ak:none #f)
    (logior           2 logior           #f            72 ,ak:immortal ,ak:none #f)
    (logxor           2 logxor           #f            73 ,ak:immortal ,ak:none #f)
    (lsh              2 lsh              #f            74 ,ak:immortal ,ak:none #f)
    (rsha             2 rsha             #f            75 ,ak:immortal ,ak:none #f)
    (rshl             2 rshl             #f            76 ,ak:immortal ,ak:none #f)
