; Ffi/ffi-test-sunos5.sch

(load "Ffi/loadffi.sch")
(load-ffi "Ffi/" 'sun4-sunos5)
...
(ffi/libraries (cons "/proj/will/lth/larceny/Ffi/ffi-test.o"
		     (ffi/libraries)))
...
(define (fp name param ret)
  ...
  (ffi/foreign-procedure ffi/SPARC-sunos5-C-callout-stdabi name 
			 (map rename param)
			 (rename ret)))
...
(define (make-callback proc args ret)
  (tr-code (ffi/make-callback ffi/SPARC-sunos5-C-callback-stdabi
			      proc args ret)))
