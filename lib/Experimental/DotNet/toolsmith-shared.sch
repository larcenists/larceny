...
;;  (on-close) 
;;  (on-keypress char) (on-keydown wnd sym mods) (on-keyup wnd sym mods)
;;  (on-mousedown x y) (on-mouseup wnd x y) (on-mousemove wnd x y) 
;;  (on-mouseclick x y) (on-mousedoubleclick wnd x y)
;;  (on-mouseenter) (on-mouseleave wnd)
