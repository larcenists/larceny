  ...
  (cond ((or help (not scheme:) (not host:))
        ...
        (else
         (let* ((host:   (case host: 
           ...
           (setup-real! scheme: host: target: c-compiler: native code-cov rebuild-code-cov)))))
...
(define (setup-real! host-scheme host-arch target-arch c-compiler-choice native code-cov rebuild-code-cov)
