...
static int log2();
void remset_update_memstats(), remset_clear_memstats();
...
static int remset_old_stats = 0;

/* Can be called from anywhere to force the remembered sets' number of
 * transactions allocated to be updated.
 */
