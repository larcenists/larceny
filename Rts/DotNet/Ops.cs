...
//        return SObject.Unspecified;
    ...
    public static SObject op1_not(SObject arg) {
        return Factory.makeBoolean(Reg.Result == SObject.False);
    }
    ...
    public static SObject op1_nullp(SObject arg) {
        return Factory.makeBoolean(arg == SObject.Null);
    }
    public static SObject op1_eof_objectp(SObject arg) {
        return Factory.makeBoolean(arg == SObject.Eof);
    }
    public static SObject op1_unspecifiedp(SObject arg) {
        return Factory.makeBoolean(arg == SObject.Unspecified);
    }
    public static SObject op1_undefinedp(SObject arg) {
        return Factory.makeBoolean(arg == SObject.Undefined);
    }
    ...
    public static SObject op1_make_cell(SObject arg) {
        return Factory.makePair(arg, SObject.False);
    }
    ...
    public static SObject op2_sys_partial_list__vector(SObject arg1, SObject arg2) {
        expect2(arg1 == SObject.Null || arg1 is SPair, arg1, arg2.isFixnum(), arg2, -1);
    ...
    public static SObject op1_make_procedure(SObject arg) {
        ...
        env[0] = SObject.False;
        for (int i = 1; i < a; ++i) {
            env[i] = SObject.Null; // So says Petit Larceny
        }
        return new Procedure(CodeVector.NoCode,
                             Factory.makeVector(0, SObject.False),
                             env);
    }
    ...
    public static SObject op2_bytevector_equal(SObject arg1, SObject arg2) {
        ...
        if (bytes1.Length != bytes2.Length) return SObject.False;
        for (int i = 0; i < bytes1.Length; ++i) {
            if (bytes1[i] != bytes2[i]) return SObject.False;
        }
        return SObject.True;
    }
